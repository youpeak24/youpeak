...
function SoundList(props) {
  ...
  const { soundListData, totalSoundList } = useSelector((state) => state.sound);
  ...
  useEffect(() => {
    dispatch(getSoundList(page, limit, startDate, endDate, search || ""));
    ...
    <div>
      <div className="user-table mb-3">
        ...
        <div className="user-table-top">
          <div className="d-flex justify-content-between align-items-center w-100">
            ...
            <div className="d-flex justify-content-end w-100">
              ...
              <Searching
                placeholder={"Search by name and sound category"}
        ...
        <Table
          ...
          mapData={soundListMapData.map((col) => ({
            ...col,
            Cell: (props) => {
              if (isLoading) {
                ...
                } else if (col.Header === "SOUND") {
                  return (
                    <div className="d-flex justify-content-center">
                      <Skeleton variant="rectangular" width={200} height={40} style={{ borderRadius: "20px" }} />
                    </div>
                  );
